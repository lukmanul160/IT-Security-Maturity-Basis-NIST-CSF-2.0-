...
const certificationRoadmapCatalogRoutes = require('./certificationRoadmapCatalogRoutes');
...
router.use('/certification-roadmap-catalog', certificationRoadmapCatalogRoutes);
